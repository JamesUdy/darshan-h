        ...
        <section className='w-full h-[86vh] flex flex-col items-center justify-center relative overflow-hidden'>
            <div className='w-[90%] xl:w-[80%] h-full flex flex-col items-center justify-center z-[1] space-y-4 translate-y-10'>
                ...
                <motion.div
                    ...
                    className="!w-[90%] xl:w-full !text-[128px] font-semibold text-center tracking-tight leading-[7.2rem] text-white flex flex-wrap break-words justify-center gap-4"
                    >
